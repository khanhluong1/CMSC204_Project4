...
public class ConcordanceDataStructureTest {
	...
	public void testAddSTUDENT() {
		...
		//Sony should be stored at index 7
		testStructure.add("Sony", 1);
		assertEquals("sony", testStructure.getWords(7).get(0));
		assertEquals(1, testStructure.getPageNumbers(7).get(0).get(0), .001);
		//Cucumber should be stored at index 18
		testStructure.add("Cucumber", 3);
		assertEquals("cucumber", testStructure.getWords(10).get(1));
		assertEquals(3, testStructure.getPageNumbers(10).get(1).get(0), .001);
		testStructure.add("Apple", 4);
		assertEquals("apple", testStructure.getWords(10).get(0));
		assertEquals(4, testStructure.getPageNumbers(10).get(0).get(1), .001);
	}
